...
class Game {
    ...
    placeBlock() {
        ...
        if (newBlocks.chopped) {
            ...
            if (newBlocks.chopped.position[newBlocks.plane] > newBlocks.placed.position[newBlocks.plane]) {       positionParams[newBlocks.plane] = '+=' + (40 * Math.abs(newBlocks.direction));
    ...
    addBlock() {
        ...
        this.scoreContainer.innerHTML = String(this.blocks.length - 0);
